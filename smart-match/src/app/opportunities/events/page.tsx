...
import { Calendar, ExternalLink, Loader2, BookOpen, Clock, ListFilter, X, PlusCircle, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-28 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <Link href="/opportunities" className="inline-flex items-center gap-2 text-slate-400 hover:text-[#471f8d] transition-colors font-bold text-sm group">
        ...
        <div className="mb-10 flex items-center justify-between border-b border-slate-200 pb-6">
          <div>
            <h1 className="text-4xl font-bold text-[#471f8d] mb-2" style={{ fontFamily: "Georgia, serif" }}>IA Events</h1>
